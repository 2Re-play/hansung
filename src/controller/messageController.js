...
const { storename_respondJson, backTofirst_respondJson, menulist_respondJson, respondOnError } = require('../lib/response')
...
exports.message = async (req, res) => {
  ...
  try {
    ...
    else if (content === '처음으로') backTofirst_respondJson(result, res, 200) // TODO: JSON 포맷 수정하기 
  } catch (e) {
